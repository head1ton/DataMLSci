...
https://github.com/fangpenlin/avataaars/tree/master
""")
...
#     hat_color=option_hat_color,
#     facial_hair_type=eval('pa.FacialHairType.%s' % option_facial_hair_type),
#     facial_hair_color=option_facial_hair_color,
...
#     clothe_color=option_clothe_color,
#     clothe_graphic_type=eval('pa.ClotheGraphicType.%s' %option_clothe_graphic_type)
# )

avatar = pa.PyAvataaar(
    # style=pa.AvatarStyle.CIRCLE,
    style=getattr(pa.AvatarStyle, option_style),
    skin_color=getattr(pa.SkinColor, option_skin_color),
    top_type=getattr(pa.TopType, option_top_type),
    hair_color=getattr(pa.HairColor, option_hair_color),
    hat_color=option_hat_color,
    facial_hair_type=getattr(pa.FacialHairType, option_facial_hair_type),
    facial_hair_color=option_facial_hair_color,
    mouth_type=getattr(pa.MouthType, option_mouth_type),
    eye_type=getattr(pa.EyesType, option_eye_type),
    eyebrow_type=getattr(pa.EyebrowType, option_eyebrow_type),
    nose_type=pa.NoseType.DEFAULT,
    accessories_type=getattr(pa.AccessoriesType, option_accessories_type),
    clothe_type=getattr(pa.ClotheType, option_clothe_type),
    clothe_color=option_clothe_color,
    clothe_graphic_type=getattr(pa.ClotheGraphicType, option_clothe_graphic_type)
)
